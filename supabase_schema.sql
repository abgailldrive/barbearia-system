...
begin
  ...
  values (
    'Novo agendamento: ' || new.service_name || ' para ' || to_char(new.date, 'DD/MM') || ' às ' || to_char(new.time, 'HH24:MI'),
    'barber'
  );
  return new;
end;
...
create policy "Only admins/barbers can manage working hours"
...
insert into public.working_hours (day_of_week, start_time, end_time, is_closed)
select d, '09:00', '18:00', case when d = 0 then true else false end
